...
using MissingPeopleDatabase.Repositories;
using Microsoft.AspNetCore.Identity;
namespace MissingPeopleDatabase
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISex, SexRepository>();
            ...
            services.AddDbContext<PeopleContext>(options => options.UseSqlServer(Configuration.GetConnectionString("dbconn")));
